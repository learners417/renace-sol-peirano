...
// El "para qué" de cada luna — el beneficio concreto que hace que el esfuerzo valga.
export const BENEFICIO = {
  1: "Cada vez que atrapás un pensamiento antes de que te maneje, le ganás un grito a la tarde. Eso es lo que entrena este ejercicio.",
  2: "Nombrar lo que sentís lo achica en el momento. Este ejercicio te da esa herramienta para el próximo desborde.",
  3: "Cuando entendés por qué reaccionás así, dejás de castigarte. Este ejercicio te devuelve compasión — y margen.",
  4: "Un pedido claro abre lo que diez reproches cierran. Este ejercicio destraba conversaciones en tu casa esta misma semana.",
  5: "Cada peso del pasado que soltás es energía que te vuelve al presente — a vos y a tus hijos. Para eso es este ejercicio.",
  6: "Este ejercicio se nota esta noche: un momento difícil con tu hijo que termina distinto. Ese es el premio.",
  7: "Un gesto de cuidado hoy = más energía mañana. Tu cuerpo devuelve rapidísimo cuando lo escuchás.",
  8: "Soltar el control de lo que no depende de vos es descanso instantáneo. Este ejercicio te saca peso de los hombros HOY.",
  9: "Reconocer estas leyes en tu día te ahorra remar contra la corriente. Es el ejercicio que ordena todos los anteriores.",
};
export const beneficioDe = (semana) => BENEFICIO[Math.min(semana, 9)] || BENEFICIO[1];
