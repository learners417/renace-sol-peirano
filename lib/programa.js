...
export const modulos = [
  ...
  },
  {
    ...
    videos: [
      { id: "v3", videoUrl: "https://www.youtube-nocookie.com/embed/ZZII-Z-LVh0", titulo: "Las emociones y creencias que construyen mi destino", subtitulo: "Módulo 2 · Parte 1",
      ...
      { id: "v4", videoUrl: "https://www.youtube-nocookie.com/embed/rypNj4bwTKU", titulo: "Las emociones y creencias que construyen mi destino", subtitulo: "Módulo 2 · Parte 2",
        desc: "Conoce cómo las creencias derivadas de tu programación mental terminan construyendo tu mundo, y cómo cambiarlas para tener un futuro mejor.",
      ...
      { id: "v5", videoUrl: "https://www.youtube-nocookie.com/embed/H9qDygcySZM", titulo: "Las emociones y creencias que construyen mi destino", subtitulo: "Módulo 2 · Parte 3",
        desc: "Conoce cómo las creencias derivadas de tu programación mental terminan construyendo tu mundo, y cómo cambiarlas para tener un futuro mejor.",
...
export const etapas = [
  {
    n: 1, nombre: "Volver a vos", modulos: [1, 2, 3], semanas: "Semanas 1–3", color: "#A990CC", icono: "🌱",
  ...
  {
    n: 2, nombre: "Vincularte y criar", modulos: [4, 5, 6], semanas: "Semanas 4–6", color: "#9D86BE", icono: "✦",
  ...
  {
    n: 3, nombre: "Sanar de manera integral", modulos: [7, 8, 9, 10], semanas: "Semanas 7–9", color: "#7E6399", icono: "🌷",
...
export const comoFunciona = [
  { icono: "☀️", titulo: "Tu sesión de cada día", texto: "Cada día es una micro-sesión: te preparás (un té, tu cuaderno), mirás tu clase —la parte teórica—, hacés la práctica (respirás, meditás, respondés) y registrás lo que cambió en tu vida. Date el tiempo tranquila. De 15 a 30 minutos según el día — los días de clase son los más largos, los de práctica los más cortos. Y en 9 semanas, tu maternidad cambia para siempre." },
