...
export const modulos = [
  {
    ...
    videos: [
      { id: "v1", titulo: "Bienvenida · Tu mente", subtitulo: "Módulo 1 · Parte 1",
      ...
      { id: "v2", titulo: "Tu mente", subtitulo: "Módulo 1 · Parte 2",
        desc: "Conoce de manera simplificada cómo funciona tu cerebro y mente, y haz que estos trabajen a tu favor.",
  ...
  },
  {
    ...
    videos: [
      { id: "v3", titulo: "Las emociones y creencias que destruyen mi destino", subtitulo: "Módulo 2 · Parte 1",
      ...
      { id: "v4", titulo: "Las emociones y creencias que destruyen mi destino", subtitulo: "Módulo 2 · Parte 2",
        desc: "Conoce cómo las creencias derivadas de tu programación mental terminan construyendo tu mundo, y cómo cambiarlas para tener un futuro mejor.",
      ...
      { id: "v5", titulo: "Las emociones y creencias que destruyen mi destino", subtitulo: "Módulo 2 · Parte 3",
        desc: "Conoce cómo las creencias derivadas de tu programación mental terminan construyendo tu mundo, y cómo cambiarlas para tener un futuro mejor.",
  ...
  },
  {
    ...
    videos: [
      { id: "v6", titulo: "Nuestra personalidad", subtitulo: "Módulo 3 · Parte 1",
      ...
      { id: "v7", titulo: "Nuestra personalidad", subtitulo: "Módulo 3 · Parte 2",
        desc: "Conocernos a nosotros mismos es una de las claves fundamentales para comenzar a comprendernos, aceptarnos, sanar, amarnos sanamente y alcanzar nuestra mejor versión.",
      ...
      { id: "v8", titulo: "Nuestra personalidad", subtitulo: "Módulo 3 · Parte 3",
        desc: "Conocernos a nosotros mismos es una de las claves fundamentales para comenzar a comprendernos, aceptarnos, sanar, amarnos sanamente y alcanzar nuestra mejor versión.",
      ...
      { id: "v9", titulo: "Nuestra personalidad", subtitulo: "Módulo 3 · Parte 4",
        desc: "Conocernos a nosotros mismos es una de las claves fundamentales para comenzar a comprendernos, aceptarnos, sanar, amarnos sanamente y alcanzar nuestra mejor versión.",
      ...
      { id: "v10", titulo: "Nuestra personalidad", subtitulo: "Módulo 3 · Parte 5",
        desc: "Conocernos a nosotros mismos es una de las claves fundamentales para comenzar a comprendernos, aceptarnos, sanar, amarnos sanamente y alcanzar nuestra mejor versión.",
  ...
  },
  {
    ...
    videos: [
      { id: "v11", titulo: "Relaciones de pareja y comunicación familiar saludable", subtitulo: "Módulo 4 · Parte 1",
      ...
      { id: "v12", titulo: "Relaciones de pareja y comunicación familiar saludable", subtitulo: "Módulo 4 · Parte 2",
        desc: "Exploraremos las formas de una comunicación familiar saludable y sentaremos las bases para una relación de pareja armoniosa y duradera, el cimiento de toda familia.",
      ...
      { id: "v13", titulo: "Relaciones de pareja y comunicación familiar saludable", subtitulo: "Módulo 4 · Parte 3",
        desc: "Exploraremos las formas de una comunicación familiar saludable y sentaremos las bases para una relación de pareja armoniosa y duradera, el cimiento de toda familia.",
  ...
  },
  {
    ...
    videos: [
      { id: "v14", titulo: "Sanar el pasado y vivir mágicamente el presente", subtitulo: "Módulo 5 · Parte 1",
      ...
      { id: "v15", titulo: "Sanar el pasado y vivir mágicamente el presente", subtitulo: "Módulo 5 · Parte 2",
        desc: "Sanar nuestro pasado, lograr reinterpretarlo y limpiarnos de emociones negativas y heridas no sanadas son las claves fundamentales para lograr un futuro exitoso y armonioso.",
      ...
      { id: "v16", titulo: "Sanar el pasado y vivir mágicamente el presente", subtitulo: "Módulo 5 · Parte 3",
        desc: "Sanar nuestro pasado, lograr reinterpretarlo y limpiarnos de emociones negativas y heridas no sanadas son las claves fundamentales para lograr un futuro exitoso y armonioso.",
  ...
  },
  {
    ...
    videos: [
      { id: "v17", titulo: "Crianza efectiva y respetuosa", subtitulo: "Módulo 6 · Parte 1",
      ...
      { id: "v18", titulo: "Crianza efectiva y respetuosa", subtitulo: "Módulo 6 · Parte 2",
        desc: "Aprender herramientas para educar a nuestros hijos de manera amorosa, pero a la vez sana y equilibrada, es la base para un mundo mejor.",
      ...
      { id: "v19", titulo: "Crianza efectiva y respetuosa", subtitulo: "Módulo 6 · Parte 3",
        desc: "Aprender herramientas para educar a nuestros hijos de manera amorosa, pero a la vez sana y equilibrada, es la base para un mundo mejor.",
  ...
  },
  {
    ...
    videos: [
      { id: "v20", titulo: "Nuestra salud física", subtitulo: "Módulo 7 · Parte 1",
      ...
      { id: "v21", titulo: "Nuestra salud física", subtitulo: "Módulo 7 · Parte 2",
        desc: "Descubre las bases fundamentales para lograr un óptimo funcionamiento de tu cuerpo físico.",
      ...
      { id: "v22", titulo: "Nuestra salud física", subtitulo: "Módulo 7 · Parte 3",
        desc: "Descubre las bases fundamentales para lograr un óptimo funcionamiento de tu cuerpo físico.",
      ...
      { id: "v23", titulo: "Nuestra salud física", subtitulo: "Módulo 7 · Parte 4",
        desc: "Descubre las bases fundamentales para lograr un óptimo funcionamiento de tu cuerpo físico.",
  ...
  },
  {
    ...
    videos: [
      { id: "v24", titulo: "La magia de confiar en la vida y la naturaleza", subtitulo: "Módulo 8",
  ...
  },
  {
    ...
    videos: [
      { id: "v25", titulo: "Las leyes universales que rigen el universo y nuestras vidas", subtitulo: "Módulo 9 · Parte 1",
      ...
      { id: "v26", titulo: "Las leyes universales que rigen el universo y nuestras vidas", subtitulo: "Módulo 9 · Parte 2",
        desc: "Comprende cómo funciona el universo y las leyes que lo rigen, para contar con una luz que siempre estará allí para guiar tu camino.",
      ...
      { id: "v27", titulo: "Las leyes universales que rigen el universo y nuestras vidas", subtitulo: "Módulo 9 · Parte 3",
        desc: "Comprende cómo funciona el universo y las leyes que lo rigen, para contar con una luz que siempre estará allí para guiar tu camino.",
...
export const semillas = [
  ...
  "Hoy riego mi jardín, aunque sea con una gota.",
...
export const comoFunciona = [
  { icono: "☀️", titulo: "Un pasito por día", texto: "Cada día abrís la app y hacés tu ritual de 10 minutos: cómo estás, tu video, tu actividad y tu semilla. Uno por día, a tu ritmo." },
  { icono: "🌷", titulo: "Tu jardín florece con vos", texto: "Cada módulo que completás, florece una flor. No es una carrera: si un día no podés, tu jardín te espera. Acá no se marchita nada." },
  ...
  { icono: "🎯", titulo: "Un camino con destino", texto: "En 12 semanas pasás de sobrevivir el día a reconectar con vos. Al final, tu graduación: tu carta, tu antes y después, tu jardín entero." },
];
