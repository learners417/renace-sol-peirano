  ...
  return (
    <div className="app app-pad" style={{ paddingTop: 24 }}>
      ...
      <div className="center stack" style={{ marginTop: 8 }}>
        ...
        <p className="tiny">{habla(pais, "Simple, un paso por día. Acá lo importante:")}</p>
      </div>
      ...
      <div className="stack" style={{ marginTop: 18 }}>
        ...
        <div className="card card-luna">
          ...
          <p className="muted" style={{ marginTop: 4 }}>{habla(pais, "En Mi renacer registrás los cambios reales de tu vida. Ver un video no alcanza: cuando algo cambia de verdad, tu Rueda de la Vida crece. Ese es tu logro.")}</p>
        </div>
        <div className="card">
          <div className="row" style={{ alignItems: "flex-start" }}>
