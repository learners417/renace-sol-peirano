  ...
  return (
    <div className="app app-pad" style={{ paddingTop: 26 }}>
      ...
      <div className="center stack" style={{ marginTop: 8 }}>
        ...
        <div className="pill pill-luna">Etapa {n}</div>
          ...
          return (
            <div key={v.id} className="card" style={{ padding: 0, overflow: "hidden" }}>
              <button className="between" style={{ width: "100%", background: "none", border: 0, padding: 16, cursor: "pointer", textAlign: "left", color: "inherit" }} onClick={() => setAbierto(open ? null : v.id)}>
                <div className="row">
                  <span style={{ width: 30, height: 30, borderRadius: "50%", display: "grid", placeItems: "center", background: hecho ? "var(--salvia-wash)" : "var(--surface-2)", color: hecho ? "#4E7256" : "var(--ink-2)", fontWeight: 800, fontSize: ".85rem" }}>{hecho ? "✓" : i + 1}</span>
